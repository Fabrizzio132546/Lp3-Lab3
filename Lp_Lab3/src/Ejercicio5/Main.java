...
public class Main {
    public static void main(String[] args) {
        ...
        notificadorCorreo.notificar("Reserva confirmada para cliente " + cli1.getNombre());

        NotificadorReserva notificadorSMS = new NotificadorReserva(new EnviadorSMS());
        notificadorSMS.notificar("Recordatorio de check-in en 24 horas");

        NotificadorReserva notificadorSlack = new NotificadorReserva(new NotificadorSlack());
        notificadorSlack.notificar("Nueva reserva creada en el sistema");
    }
}
